...
function addFlight() {
    ...
    fetch("http://projectmy.ddnsking.com/api/add_flight", {
        method: 'POST',
...
function deleteFlight() {
    ...
    fetch("http://projectmy.ddnsking.com/api/delete_flight/${flightId}", {
        method: 'DELETE'
    })
    .then(response => response.json())
    .then(data => alert(data.message))
...
function fetchFlights() {
    fetch("http://projectmy.ddnsking.com/api/fetch_flights")
    .then(response => {
        if (!response.ok) {
